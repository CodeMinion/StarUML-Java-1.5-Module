...
{******************************************************************************}
{
  ...
  MODIFICATIONS:
  PJavaParserObj.AnalyzeJavaEnumDeclaration
  PJavaParserObj.AnalyzeJavaEnumDeclaration
  PJavaParserObj.FillOutEnumAttributes
  PJavaParserObj.AnalyzeJavaEnumMembersDeclaration
  PJavaParserObj.AnalyzeJavaEnumFieldDeclararion

  Added to support Enums fully. Now enums are generated as nested classes
  with the prefix enum. They can have methods, constructors, etc.
